...
all_100_plots <- ggplot(data.frame(all_stain_100_gene), aes(all_stain_100_gene)) +
                  geom_histogram(fill = "grey", color = "black") +
                  theme_classic() +
                  labs(title = "100 Genes",
                       x = "Staining Score")

ggarrange(all_10_plots, all_25_plots, all_50_plots, all_100_plots)
ggsave("data_out/extended_fig_2_all_perm_plots.pdf", width = 7, height = 6)
```
...
ggsave("data_out/extended_fig_1_top_ten_perm_plots.pdf", width = 7, height = 6)
```
